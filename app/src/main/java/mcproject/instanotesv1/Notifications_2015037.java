...
public class Notifications_2015037 extends AppCompatActivity{

    private RecyclerView recyclerView;
    private NotifAdapter_2015037 adapter;
                                                                    ...
                                                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                                                        if (task.isSuccessful()) {
                                                                            ...
                                                                            if (document.exists()) {
                                                                                ...
                                                                                Log.d("desc", desc);
                                                                                notifList.add(new Notif_2015037(courseName + " notes requested by " + user, desc, R.drawable.person_photo));
                                                                                Log.d("desc", String.valueOf(notifList.size()));
                                                                                adapter = new NotifAdapter_2015037(Notifications_2015037.this, notifList);
