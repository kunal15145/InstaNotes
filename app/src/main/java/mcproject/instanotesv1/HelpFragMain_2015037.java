...
public class HelpFragMain_2015037 extends Fragment implements View.OnClickListener {
    ...
    private void changeFragment(){
        ...
        ft.replace(R.id.main,new HelpFrag1_2015037()).addToBackStack(null).commit();
    }
    ...
    private void changeFragment5() {
        FragmentTransaction ft=getFragmentManager().beginTransaction();
        ft.setCustomAnimations(R.animator.slide_up,0);
        ft.replace(R.id.main,new HelpFrag5_2015037()).addToBackStack(null).commit();
    }

    private void changeFragment4() {
        FragmentTransaction ft=getFragmentManager().beginTransaction();
        ft.setCustomAnimations(R.animator.slide_up,0);
        ft.replace(R.id.main,new HelpFrag4_2015037()).addToBackStack(null).commit();
    }

    private void changeFragment3() {
        FragmentTransaction ft=getFragmentManager().beginTransaction();
        ft.setCustomAnimations(R.animator.slide_up,0);
        ft.replace(R.id.main,new HelpFrag3_2015037()).addToBackStack(null).commit();
    }

    private void changeFragment2() {
        FragmentTransaction ft=getFragmentManager().beginTransaction();
        ft.setCustomAnimations(R.animator.slide_up,0);
        ft.replace(R.id.main,new HelpFrag2_2015037()).addToBackStack(null).commit();
    }
    @Override
